...
gulp.task('bar', () => spawn('pandoc', ["-t", "revealjs", '-s', '-o', 'index.html', 'slides.md', '-V', 'revealjs-url=https://unpkg.com/reveal.js/', '-V', 'theme=beige'], { stdio: 'inherit' }))
...
gulp.task('serve', () => {
    ...
    console.log(slidesRoot)
    gulp.watch(['slides.md'], gulp.series('bar'))
    gulp.watch([
        slidesRoot + '**/*.html',
        slidesRoot + '**/*.md',
